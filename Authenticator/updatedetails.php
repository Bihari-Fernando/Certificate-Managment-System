...
<body>
    ...
    <div class="maincontent">
        ...
        <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="updatedetails.php">Update Details</a></li>
...
$sql = "SELECT * FROM transcript WHERE status='U'";
...
$result = $conn->query($sql);
                            ...
                            <?php while ($row = $result->fetch_assoc()) { ?>
                                ...
                                <td> <a href="subupdatepage.php?regNo=<?php echo $row['regNo'] ?>"><button id = "updateButton">View<button></a> </td>
                                </tr>
                            <?php } ?>
                            </table>
                            ...
                            for ($i = 1; $i <= $total_pages; $i++) {
                                echo '<a href="updatedetails.php?page=' . $i . '&search=' . htmlentities($search_query) . '">' . $i . '</a>';
                            }
                            echo '</div>';
