...
<table>
                            ...
                            <?php while ($row = $result->fetch_assoc()) { ?>
                                ...
                                <td><a href="subcomplains.php?regNo=<?php echo $row['regNo'] ?>"><button id = "updateButton">View<button></a> </td>
                                </tr>
                            <?php } ?>
                            </table>
                            ...
                            for ($i = 1; $i <= $total_pages; $i++) {
                                echo '<a href="viewcomplains.php?page=' . $i . '&search=' . htmlentities($search_query) . '">' . $i . '</a>';
                            }
                            echo '</div>';
