...
$query = "SELECT * FROM topstudents WHERE regNo = '$regNo'";
...
<head>
  ...
  <title>OCDS | Download Top Graded Student Certificate</title>
  ...
  <div class="container">
    <div class="card complaint-card" id='in'>
        ...
        <div class="certificate-title">
          ...
          <h4 class="sub-title">Certificate of Top Graded Students</h4>
        </div>
        <div class="certificate-details">
          ...
          <div class="detail-row-grid2">
            <h5>GPA: </h5>
            <p><?php echo $obj['gpa'] ?></p>
          </div>
          <div class="detail-row-grid2">
            <h5>Academic Year: </h5>
            <p><?php echo $obj['academicYear'] ?></p>
          </div>
          <div class="detail-row-grid2">
            <h5>Exam Index No: </h5>
            <p><?php echo $obj['indexNo'] ?></p>
          </div>
          <div class="detail-row-grid2">
            <h5>Status: </h5>
            <p style="color: green !important"><?php echo $obj['status'] ?></p>
          </div>
          <p>Visit ucis.infinityfreeapp.com to verify</p>
        </div>
