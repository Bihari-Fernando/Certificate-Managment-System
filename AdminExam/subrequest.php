    ...
    <div class="maincontent">
        ...
        <?php
            ...
            if (isset($_POST['verify'])) {
                ...
                $query = "UPDATE transcript SET  status='V' WHERE regNo='$regNo'";
                echo $query;
        ...
        <div class="mainbox">
            ...
            <table>
                ...
                <tr>
                 ...
                 <button  onclick="req('<?php echo $updateRegRow['regNo'];?>','verify')"></button> 
                 <button  onclick="req('<?php echo $updateRegRow['regNo'];?>','Delete')"></button>
